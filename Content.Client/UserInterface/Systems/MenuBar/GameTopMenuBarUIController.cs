...
public sealed class GameTopMenuBarUIController : UIController
{
    ...
    [Dependency] private readonly ConsentUiController _consent = default!; // Nebulous - Consent System
    ...
    public void UnloadButtons()
    {
        ...
        _consent.UnloadButton(); // Nebulous - Consent System
    }
    ...
    public void LoadButtons()
    {
        ...
        _sandbox.LoadButton();
        _emotes.LoadButton();
        _consent.LoadButton(); // Nebulous - Consent System
    }
}
